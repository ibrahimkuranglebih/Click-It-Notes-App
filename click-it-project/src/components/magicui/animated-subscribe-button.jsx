    ...
    (<AnimatePresence mode="wait">
      {isSubscribed ? (
        <motion.button
          ref={ref}
          className={cn(
            "relative flex h-10 w-fit items-center justify-center px-3 overflow-hidden rounded-lg bg-primary text-primary-foreground",
            className
          )}
          onClick={(e) => {
          ...
          <motion.span
            key="action"
            className="relative flex h-full w-fit items-center justify-center font-semibold"
            initial={{ y: -50 }}
            animate={{ y: 0 }}>
        ...
        <motion.button
          ref={ref}
          className={cn(
            "relative flex h-10 w-fit cursor-pointer items-center justify-center rounded-lg border-none bg-primary px-3 text-primary-foreground",
            className
          )}
          onClick={(e) => {
